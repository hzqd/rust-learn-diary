...
mod tests {
    ...
    fn test_57() {
        assert_eq!(
            Solution::insert(vec![Interval::new(1,3),Interval::new(6,9)], Interval::new(2,5)),
            vec![Interval::new(1,5),Interval::new(6,9)]
        );
        assert_eq!(
            Solution::insert(vec![Interval::new(1,2),Interval::new(3,5),Interval::new(6,7),Interval::new(8,10),Interval::new(12,16)], Interval::new(4,8)),
            vec![Interval::new(1,2),Interval::new(3,10),Interval::new(12,16)]
        );
        assert_eq!(
        ...
        assert_eq!(
            Solution::insert(vec![Interval::new(1,2), Interval::new(3,4)], Interval::new(0,6)),
